...
if(isset($_REQUEST['enviarcomentario']))
{
  ...
  if ($email=="" OR $comentario=="") {
  	...
  	$destinatario="mguerra@iastur.es";
  	// el origen es $email
  	// el mensaje es $comentario
  	$titulo="Comentario enviado desde MiTienda On-line";
  	$textoaenviar="
  	<html>
  	 <head>
  	   <title>Correo enviado desde MiTienda On-Line</title>
  	 </head>
  	 <body>
	   <h1>Correo desde MiTienda On-Line</h1>
...
$cabeceras.="To: Miguel <$destinatario>"."\r\n";
