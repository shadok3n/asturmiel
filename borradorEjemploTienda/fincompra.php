...
<!-- direccion de correo de vendedor -->
	<input type="hidden" name="business" value="misupertienda@supertienda.com">
...
<!-- definir el tipo de moneda -->
    ...
    ?>
	<input type="image" src="imagenes/paypal1024.jpg" name="submit" border="0" alt="Paypal. La forma más segura de comprar y vender.">
    </form>
    <?php 
 	}else{
   ?>
