...
<section class="col-md-6">
  <h1 class="naranja">Articulos de la categoria</h1>	
  <div class="row">
<?php 
$conta=0;
foreach ($listado as $indice => $valor) {
 ...
 echo "<div class='row'>";
 echo "<div class='col-md-6 negrobold'>";
 echo $valor['nombreArticulo'];
 echo "<br>Precio: ".$valor['precio']."€";
 echo "</div><div class='col-md-6'>";
 echo "<img src='admin/".$valor['fotoArticulo']."' width='50px'></div></div>"; 
 echo "<a href='indexarticulo.php?idArticulo=".$valor['idArticulo']."'><i class='fas fa-search'></i></a>";
 echo " | <a href='indexarticulos.php?idArticulo=".$valor['idArticulo']."&idSubcat=$idSubcat&posicion=$posicion&articulosPorPagina=$articulosPorPagina&alcarrito=ok'><i class='fas fa-cart-plus'></i></a> <hr>";
 echo "</div>";
 if ($conta==3) {
